<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            <a href="home" class="nav-item nav-link second-header <?= $index?>">Home</a>
            <a href="about" class="nav-item nav-link second-header <?= $about?>">About Us</a>
            <a href="services" class="nav-item nav-link second-header <?= $service?>">Services</a>
