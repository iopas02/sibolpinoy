 ...
 <div class="container-fluid bg-dark text-light footer pt-5">
        <div class="container py-5 wow fadeIn" data-wow-delay="0.2s">
            <div class="row g-5">
                    ...
                    <h2 class="text-white mb-3 header-font">TAKE YOUR BUSINESS TO THE NEXT LEVEL</h2>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex pt-2">
                        ...
                        <a class="btn btn-outline-light btn-social" href="https://twitter.com/sibolpinoy_mc?fbclid=IwAR38mQPr9jGG5ETUB90eWKqhK9g-zso-ABBS2YEO1rLxSNv8VfhX2NvLlUQ"><i class="fab fa-twitter"></i></a>

                        <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/SibolPINOY/about/?ref=page_internal"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-outline-light btn-social" href="https://www.instagram.com/sibolpinoy_mc/"><i class="fab fa-instagram"></i></a> 
                        <a class="btn btn-outline-light btn-social" href="https://www.linkedin.com/company/sibol-pinoy-management-consultancy/"><i class="fab fa-linkedin-in"></i></a>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="" href="#">Sibol-Pinoy</a>, All Right Reserved 2022.
<!--                    
