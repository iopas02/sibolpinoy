        ...
        if(!mysqli_stmt_prepare($stmt, $uniID_query )) {
            ...
            if($resultcheck > 0) {
                ...
                if(in_array($image_ex_loc, $allowed_ex)){
                    ...
                    $insert_services = "INSERT INTO `services`(`service_uniID`, `service_title`, `image`, `service_desc`, `date_upload`, `date_update`) VALUES ('$uniID', '$service_title','$new_image_name','$service_desc','$date', '$date')";
