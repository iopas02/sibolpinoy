<!-- THIS IS FOR SUB NAV-BAR FOR CONSULTATION REPORST START HERE -->
<nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container-fluid border-bottom border-3 border-dark mb-2">
            <a class="navbar-brand" href="#">Reporst Table</a>
...
<!-- THIS IS FOR SUB NAV-BAR FOR CONSULTATION REPORST END HERE -->